...
public:
	...
	//images
	static std::vector<SDL_Texture*> gCar;
	static std::vector<SDL_Texture*> gExplode;
	static std::vector<SDL_Texture*> gFire;
	static std::vector<SDL_Texture*> gSpeedometer;
	static SDL_Texture* gBG;
	static SDL_Texture* gBarrel;
	static SDL_Texture* gCarWrecked;
